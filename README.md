Grima -- PyGTK+ plot widgets based on matplotlib
===
...
## INSTALLATION
    ...
    cd grima
    git-new-workdir git-repo v1.3.2 v1.3.2

Please note that "grima/v1.3.2" is required by the packages that
 ...
 * [Elrond v1.3.1](http://github.com/cdsi/elrond)
